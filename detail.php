            ...
            <div style="position: relative;left: 25%;" class="row">
                <div class="col-md-12">
                    <table class="ta">
                        ...
                        <tr>
                            <th class="ta1">Products</th>
                            <th class="ta1">Images</th>
                            <th class="ta1">Quantity</th>
                        ...
                        <?php
                            ...
                            $sql = "SELECT idhanghoa,idhoadon,tenhang,images,dathang.soluong,dathang.dongia FROM `dathang` INNER join hanghoa on dathang.idhanghoa = hanghoa.id where idhoadon =  $id;";
                            $kq = mysqli_query($conn,$sql);
                            while($row = mysqli_fetch_assoc($kq)){
                                $total += $row['dongia'];
                        ?>
                        <tr>
                            <td class="ta2"><?php echo $row['tenhang']; ?></td>
                            <td class="ta2"><img style="width:100px;height:100px;" src="assets/img/menu/<?php echo $row['images']; ?>"></td>
                            <td class="ta2"><?php echo $row['soluong']; ?></td>
                            <td class="ta2"><?php echo $row['dongia']; ?></td>
                        </tr>
                        <?php
                            }
                        ?>
                        
                    </table> <h2 style="color: red;position: relative;left:630px">Total:<?php echo $total; ?></h2> 
                </div>
            </div>
