...
if(isset($_SESSION['cart'])){
    ...
    while($row = mysqli_fetch_array($kq)){
        ...
        echo '<div class="cart-item d-flex justify-content-between text-capitalize my-3">
                ...
                <a href="#" id="cart-item-remove" onclick="delete_cart('.$id1.')" class="cart-item-remove">
...
<div class="cart-buttons-container mt-3 d-flex justify-content-between">
    ...
    <a href="checkout.php" id="clear-cart" class="btn btn-pink text-uppercase">checkout</a>
</div>
<?php
    }
?>
